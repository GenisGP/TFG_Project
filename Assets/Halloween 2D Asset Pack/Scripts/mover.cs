...
public class mover : MonoBehaviour {
    ...
    void LateUpdate () {
        ...
        if (Input.GetKey (KeyCode.Q) && Player.position.x >= minDistanceX) {
        ...
        if (Input.GetKey (KeyCode.E) && Player.position.x <= maxDistanceX) {
        ...
        if (Input.GetKey (KeyCode.R) && Player.position.y >= minDistanceY && canMoveY) {
        ...
        if (Input.GetKey (KeyCode.T) && Player.position.y <= maxDistanceY && canMoveY) {
